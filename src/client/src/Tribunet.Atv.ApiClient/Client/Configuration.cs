...
namespace Tribunet.Atv.ApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.comprobanteselectronicos.go.cr/recepcion/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.comprobanteselectronicos.go.cr/recepcion/v1") : this()
        {
        ...
        {
            string report = "C# SDK (Tribunet.Atv.ApiClient) Debug Report:\n";
